    ...
    if (xmlFile) {
        fetch(xmlFile)
            ...
            .then(data => {
                ...
                const cars = xmlDoc.querySelector('wagoneer') || xmlDoc.querySelector('grand_wagoneer') || xmlDoc.querySelector('gladiator')|| xmlDoc.querySelector('renegade')|| xmlDoc.querySelector('wringer_4xe')|| xmlDoc.querySelector('wringer')|| xmlDoc.querySelector('grand_cherokee_wl_4xe')|| xmlDoc.querySelector('grand_cherokee_wl')|| xmlDoc.querySelector('compass') ;
